...
.controller('menuCtrl', function($scope,$http,sharedCartService,sharedFilterService,MstUsers) {
...
.controller('loginCtrl', function($scope,$http,$ionicPopup,$state,$ionicHistory,Mstusers) {
		$scope.user = {};
